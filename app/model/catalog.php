...
/**
 * Catalog 封装来自 catalog 数据表的记录及领域逻辑
 * @author WangZhen <thinkgem@163.com>
 */
class Catalog extends QDB_ActiveRecord_Abstract
{

    function _before_save(){
        $catalog = self::find()->getById($this->_props['parent_id']);
        $this->changePropForce('path', $catalog->path.$this->_props['parent_id'].',');
    }
