<?php
// $Id: roleshaspermissions.php 895 2010-03-23 05:36:29Z thinkgem $

/**
 * RolesHasPermissions 封装来自 roles_has_permissions 数据表的记录及领域逻辑
 * @author WangZhen <thinkgem@163.com>
 */
class RolesHasPermissions extends QDB_ActiveRecord_Abstract
{
    ...
    static function __define()
    {
        ...
        (
            ...
            // 用什么数据表保存对象
            'table_name' => 'roles_has_permissions',
            ...
            (
                ...
                'permission_id' => array('readonly' => true),
             ...
             */
            'attr_protected' => 'role_id, permission_id',
