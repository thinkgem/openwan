...
/**
 * Permissions 封装来自 permissions 数据表的记录及领域逻辑
 * @author WangZhen <thinkgem@163.com>
 */
class Permissions extends QDB_ActiveRecord_Abstract
{
...
//                //权限对应一个或者多个用户
//                'users' => array(
//                    QDB::MANY_TO_MANY => 'admin_users',
//                    'mid_source_key' => 'permission_id',
//                    'mid_target_key' => 'user_id',
//                    'mid_table_name' => 'users_have_permissions'
//                ),
//                //权限对应一个或者多个组
//                'groups' => array(
//                    QDB::MANY_TO_MANY => 'admin_groups',
//                    'mid_source_key' => 'permission_id',
//                    'mid_target_key' => 'group_id',
//                    'mid_table_name' => 'groups_have_permissions'
//                ),
                //权限对应一个或者多个角色
                'roles' => array(
                    ...
                    'mid_table_name' => 'roles_has_permissions',
            ...
            (
                'namespace' => array
                (
                    array('max_length', 64, '命名空间不能超过 64 个字符'),

                ),

                'controller' => array
                (
                    array('max_length', 64, '控制器不能超过 64 个字符'),

                ),

                'action' => array
                (
                    array('max_length', 64, '操作不能超过 64 个字符'),

                ),

                'aliasname' => array
                (
                    array('max_length', 64, '注释名不能超过 64 个字符'),

                ),

                'rbac' => array
                (
                    array('max_length', 32, '系统角色不能超过 32 个字符'),
