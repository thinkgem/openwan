<?php
// $Id: groups.php 895 2010-03-23 05:36:29Z thinkgem $

/**
 * Groups 封装来自 groups 数据表的记录及领域逻辑
 * @author WangZhen <thinkgem@163.com>
 */
class Groups extends QDB_ActiveRecord_Abstract
{
    ...
    static function __define()
    {
        ...
        (
            ...
            (
                ...
                //每个组拥有多个用户
                'users' => array(QDB::HAS_MANY => 'users', 'target_key' => 'group_id'),
                //每个组拥有一个或者多个角色
                'roles' => array(
                    QDB::MANY_TO_MANY => 'roles',
                    'mid_source_key' => 'group_id',
                    'mid_target_key' => 'role_id',
                    'mid_table_name' => 'groups_has_roles',
                    'on_find_where' => 'enabled=1'
                ),
//                //每个组除了角色和分组之外还可以拥有多个额外的权限
//                'permissions' => array(
...
//                ),
                //每个组所能接入的分类
                'categorys' => array(
                    QDB::MANY_TO_MANY => 'category',
                    'mid_source_key' => 'group_id',
                    'mid_target_key' => 'category_id',
                    'mid_table_name' => 'groups_has_category',
                    'on_find_order' => 'weight desc',
                    'on_find_where' => 'enabled=1'
                ),
            ...
            (
                ...
                (
                    ...
                    array('max_length', 32, '名称不能超过 32 个字符'),
                ...
                'quota' => array
                (
                    array('is_int', '用户磁盘配额（MB）必须是一个整数'),
