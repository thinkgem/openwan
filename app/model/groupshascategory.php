<?php
// $Id: groupshascategory.php 895 2010-03-23 05:36:29Z thinkgem $

/**
 * GroupsHasCategory 封装来自 groups_has_category 数据表的记录及领域逻辑
 * @author WangZhen <thinkgem@163.com>
 */
class GroupsHasCategory extends QDB_ActiveRecord_Abstract
{
    ...
    static function __define()
    {
        ...
        (
            ...
            // 用什么数据表保存对象
            'table_name' => 'groups_has_category',
             ...
             */
            'attr_protected' => 'group_id, category_id',
